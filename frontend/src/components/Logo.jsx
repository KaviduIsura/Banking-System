  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
      ...
      >
        ...
        <path
          d="M32 3 L56 16 V40 C56 51 45 58 32 61 C19 58 8 51 8 40 V16 Z"
          fill="#241A10"
          stroke="url(#g1)"
          strokeWidth="1.6"
        />
        ...
        />
        <path
          d="M36.4 26.8c-0.6-1.4-2-2.3-4-2.3-2.5 0-4.1 1.3-4.1 3.1 0 2 1.7 2.7 4 3.3 3 0.8 5.7 1.7 5.7 4.9 0 2.9-2.4 4.7-5.8 4.7-2.9 0-5.1-1.2-6-3.4"
          fill="none"
          stroke="#FFFDF8"
          strokeWidth="2.2"
          strokeLinecap="round"
      ...
      {showWordmark && (
        ...
        >
          Secure Bank<span style={{ color: "var(--gold)" }}>.</span>
        </span>
      )}
    </div>
  );
