...
export default function AdminAuditLog() {
  ...
  const getEventColor = (type) => {
    if (
      ...
      return "var(--danger)";
    if (type.includes("SUCCESS") || type.includes("REGISTER"))
      return "var(--teal)";
    return "var(--ink-soft)";
  };
  ...
  return (
    <div style={{ animation: "fadeIn 0.4s ease-out" }}>
      ...
      >
        ...
        <strong>Admin Restricted Zone:</strong> This audit log is
        cryptographically immutable. All system events are permanently recorded.
      </div>
              ...
              {loading ? (
                ...
                pending.map((tx, i) => (
                  <tr
                    ...
                    style={{
                      borderBottom:
                        i < pending.length - 1 ? "1px solid #E5E7EB" : "none",
                    }}
                  >
                    <td
                      style={{
                    ...
                    >
                      LKR{(tx.amount_cents / 100).toFixed(2)}
                    </td>
