...
export default function Transfer() {
  ...
  const handleConfirm = async () => {
    if (!mfaCode || mfaCode.length !== 6)
      return toast.error("Enter a 6-digit MFA code");
    setLoading(true);
  ...
  const resetForm = () => {
    ...
    // Reload balance
    getBalance()
      .then((res) => setBalance(res.data.balance_cents))
      .catch(console.error);
  };
      ...
      <div className="card">
        {step === 1 && (
          <form onSubmit={handleReview}>
            <div className="form-group">
              ...
              <select className="form-input" disabled value={accountNumber}>
                <option value={accountNumber}>
                  {accountNumber || "Loading..."} (Available: LKR
            ...
            >
              ...
              >
                Every transfer is signed with your account's private key and
                recorded permanently on the immutable ledger.
              </p>
            </div>
        ...
        {step === 3 && (
          <div>
            ...
            >
              For your security, please verify this transaction with your
        ...
        {step === 4 && successData && (
          ...
          >
            ...
            >
              {successData.status === "pending_review" ? <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> : <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>}
            </div>
            ...
            >
              {successData.message ||
                `You sent ${successData.amount} to ${successData.to_account}.`}
            </p>
