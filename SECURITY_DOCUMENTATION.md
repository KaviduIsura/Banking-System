...
- **Chaining Mechanism:** Each new log entry calculates a SHA-256 hash that includes its own data *plus* the hash of the previous log entry.
...
Transfers exceeding a specific threshold (e.g., £1,000) do not execute immediately.
