...
**Headers:** `Authorization: Bearer <token>`  
**Description:** Transfers funds to a recipient account. Requires a valid 6-digit MFA code. Large transfers (>= LKR1000) are placed in a `pending_review` state for admin approval.  
**Request Body:**
